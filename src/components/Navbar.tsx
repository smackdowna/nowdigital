...
const Navbar = () => {
    return (
        <nav
            className="relative bg-gradient-light flex items-center justify-between h-[60px] xl:h-[55px] "
        >
            {/* logo */}
                ...
                <div className="bg-white bg-opacity-50 flex-grow  justify-between  pl-16  px-10 h-full rounded-b-lg flex items-center  ">
                    ...
                    <div className="flex justify-center gap-10">
                        <div className="flex gap-4">
                            <button className=" bg-white border-[2px] border-[#0055FF] text-[#0055FF] px-2 py-1 rounded-[4px] text-[15px] font-bold">Log in</button>
                            <button className=" bg-[#0055FF] text-white px-2 py-1 rounded-[4px] text-[15px] font-bold">Sign Up</button>

...
const SignUpUser = ({ onClose, isOpen }) => {
    ...
    const onSubmit = (data) => {
        // Add country and gstin to the form data
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="mt-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2">
                                        <button
                                            type="submit"
                                            className="bg-home-primary text-white text-xl font-roboto py-2 font-700 rounded-lg mt-4 w-full"
                                        >
                                            Create Account
                                        </button>
                                        <div className='text-center mt-4'>
                                            <span>Already have an account? <span className='text-home-primary cursor-pointer'>Sign in</span></span>
                                        </div>
                                    </div>
                                </div>
                            </form>

...
const SummaryPage = () => (
    <div className="font-sans overflow-x-hidden overflow-y-auto">
        <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-white text-center whitespace-nowrap">
                <tr>
                    <th className="px-4 py-4 text-xs font-bold text-black tracking-wider">
                        Product
                    </th>
                    <th className="px-4 py-4 text-xs font-bold text-black tracking-wider">
                        Duration
            ...
            <tbody className="bg-white divide-y divide-gray-200 whitespace-nowrap">
                <tr>
                    ...
                    <td className="text-sm text-gray-800">
                        <div className="relative font-[sans-serif] w-max mx-auto">
                            <select
                                className="w-full h-10 border border-gray-300 text-gray-800 text-sm outline-none bg-white hover:bg-gray-50">
                ...
                <tr>
                    <td className="flex items-center px-4 py-4 text-sm text-blue-800">
                        <ul className='bg-white'>
                            <li className=''></li>
                            <li className='py-1 font-bold cursor-pointer'>Have a Coupon Code?</li>
...
const LoginPage = () => (
    <div className="flex flex-col justify-center">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 className="mt-2 text-left text-base font-bold leading-9 tracking-tight text-gray-900">Existing User?</h2>
...
const Cart: React.FC<SidebarProps> = ({ onClick }) => {
    ...
    return (
        <div className="w-[40vw] ml-auto bg-white shadow-lg hs-overlay fixed inset-0 z-50 block">
            {/* Header */}

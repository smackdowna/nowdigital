...
const Possibilities: React.FC = () => {
    ...
    return (
        <div className="p-10 max-lg:p-2 bg-[#FFFBF0]">
            <div className="flex justify-center text-[43px] max-lg:text-[38px] max-md:text-3xl text-center tracking-tighter font-900 text-[#000659] mt-10">
            ...
            <div className="flex justify-center flex-wrap gap-6 max-lg:gap-4 mt-10">
                {cardContent.map((content, index) => (
                    <div
                        ...
                        className={`relative w-[375px] max-lg:w-[340px] h-[145px] hover:scale-105 rounded-[10px] p-[2px] transition-all duration-700 ${hoveredCard === index ? 'bg-gradient-to-r from-blue-500 to-yellow-500' : 'bg-transparent'}`}
                    >
                        <div className="w-full h-full bg-white rounded-[8px] p-6">
                            ...
                            <div className="text-[#000334] font-serif mt-3 text-[15px] opacity-60 w-[370px] max-lg:w-[300px]">

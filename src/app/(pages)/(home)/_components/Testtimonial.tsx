...
const Testimonials: React.FC = () => {
    ...
    return (
        <div className="bg-[#FFFBF0] gap-10 pb-36 max-md:pb-10">
            <div className="pt-28 max-md:pt-10 flex justify-center text-[#000334]">
            ...
            <div className="pb-10 pt-8 flex justify-center text-[#000659]">
                <span className="text-dark-200 text-[42px] max-lg:text-4xl max-lg:w-[500px] max-md:text-2xl max-md:w-[300px] tracking-tighter font-900 text-center">
